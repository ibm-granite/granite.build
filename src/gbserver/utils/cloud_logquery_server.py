...
class IBMCloudLogServerQueryAPI:
    """
    ...
    def __init__(self, api_endpoint: str, api_key: str = ""):
        ...
        """
        logger.info("IBMCloudLogServerQueryAPI.__init__ api_endpoint %s", api_endpoint)
...
def get_log_server_manager():
    ...
    if is_standalone():
        ...
        assert (
            GBSERVER_IBM_CLOUD_SERVER_LOGS_API_URL != ""
        ), "GBSERVER_IBM_CLOUD_SERVER_LOGS_API_URL has not been set"
        assert (
            GBSERVER_IBM_CLOUD_SERVER_LOGS_API_KEY != ""
        ), "GBSERVER_IBM_CLOUD_SERVER_LOGS_API_KEY has not been set"
        _LOG_SERVER_MANAGER = IBMCloudLogServerQueryAPI(
            api_endpoint=GBSERVER_IBM_CLOUD_SERVER_LOGS_API_URL,
            api_key=GBSERVER_IBM_CLOUD_SERVER_LOGS_API_KEY,
        )
        logger.info(
            "created an IBM Cloud Logs API client for server/admin %s",
            _LOG_SERVER_MANAGER,
        )
    return _LOG_SERVER_MANAGER
