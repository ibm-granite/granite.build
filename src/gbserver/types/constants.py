...
ENV_VAR_GBSERVER_WEBHOOKS_ENABLED = ENV_VAR_PREFIX + "_WEBHOOKS_ENABLED"
GBSERVER_WEBHOOKS_ENABLED: bool = getenv_boolean(
    ENV_VAR_GBSERVER_WEBHOOKS_ENABLED, True
)
...
ENV_VAR_GBSERVER_WEBHOOKS_ALLOW_HTTP = ENV_VAR_PREFIX + "_WEBHOOKS_ALLOW_HTTP"
GBSERVER_WEBHOOKS_ALLOW_HTTP: bool = getenv_boolean(
    ENV_VAR_GBSERVER_WEBHOOKS_ALLOW_HTTP, False
)
...
ENV_VAR_GBSERVER_WEBHOOKS_MAX_PER_SPACE = ENV_VAR_PREFIX + "_WEBHOOKS_MAX_PER_SPACE"
GBSERVER_WEBHOOKS_MAX_PER_SPACE: int = int(
    os.environ.get(ENV_VAR_GBSERVER_WEBHOOKS_MAX_PER_SPACE, "20")
)

ENV_VAR_GBSERVER_WEBHOOKS_MAX_PER_USER = ENV_VAR_PREFIX + "_WEBHOOKS_MAX_PER_USER"
GBSERVER_WEBHOOKS_MAX_PER_USER: int = int(
    os.environ.get(ENV_VAR_GBSERVER_WEBHOOKS_MAX_PER_USER, "50")
)
