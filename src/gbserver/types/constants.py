...
CODE_GBSERVER_BUILTINS_STEPS_COSRCLONE_DIR = CODE_GBSERVER_BUILTINS_STEPS_DIR / "cosrclone"
...
ENV_VAR_BUILDRUNNERJOB_CONFIGMAP_NAME = ENV_VAR_PREFIX + "_BUILDRUNNERJOB_CONFIGMAP_NAME"
...
ENV_VAR_GBSERVER_NODE_HEALTH_ALERT_WEBHOOK_URL = ENV_VAR_PREFIX + "_NODE_HEALTH_ALERT_WEBHOOK_URL"
...
ENV_VAR_GBSERVER_DEFAULT_GH_REQUEST_TIMEOUT = ENV_VAR_PREFIX + "_DEFAULT_GH_REQUEST_TIMEOUT"
...
ENABLE_SSH_HOST_KEY_VERIFICATION = (
    os.getenv(ENV_VAR_GBSERVER_ENABLE_SSH_HOST_KEY_VERIFICATION, "false").lower() == "true"
)
GBSERVER_ENABLE_STEP_RETRY = os.getenv(ENV_VAR_GBSERVER_ENABLE_STEP_RETRY, "true").lower() == "true"
# Metrics
...
PUSH_METRICS_TIMEOUT = int(os.getenv(ENV_VAR_GBSERVER_PUSH_METRICS_TIMEOUT, "10"), base=10)
DEFAULT_WORKSPACE_DIR = os.getenv(ENV_VAR_PREFIX + "_DEFAULT_WORKSPACE_DIR", "gbserverworkspace")
...
DEFAULT_ROOT_PRWATCHER_WORKSPACE_DIR = DEFAULT_ROOT_WORKSPACE_DIR + "/gbserver-prwatcher-workspace"
...
MAX_PR_CREATION_TRIES = int(os.getenv(ENV_VAR_PREFIX + "_MAX_PR_CREATION_TRIES", "100"), base=10)
...
LAKEHOUSE_MAX_RETRIES = int(os.getenv(ENV_VAR_PREFIX + "_LAKEHOUSE_MAX_RETRIES", "100"), base=10)
LAKEHOUSE_BASE_DELAY = float(os.getenv(ENV_VAR_PREFIX + "_LAKEHOUSE_BASE_DELAY", "0.5"))
GIT_CLONE_MAX_RETRIES = int(os.getenv(ENV_VAR_PREFIX + "_GIT_CLONE_MAX_RETRIES", "5"), base=10)
GIT_CLONE_RETRY_MIN_WAIT = float(os.getenv(ENV_VAR_PREFIX + "_GIT_CLONE_RETRY_MIN_WAIT", "1"))
GIT_CLONE_RETRY_MAX_WAIT = float(os.getenv(ENV_VAR_PREFIX + "_GIT_CLONE_RETRY_MAX_WAIT", "30"))
# GitHub API retry configuration
GITHUB_API_MAX_RETRIES = int(os.getenv(ENV_VAR_PREFIX + "_GITHUB_API_MAX_RETRIES", "10"), base=10)
...
GBSERVER_GITHUB_TOKEN = os.getenv(ENV_VAR_DEFAULT_GITHUB_TOKEN, os.getenv("GITHUB_TOKEN", ""))
...
GBSERVER_REST_SERVER_WORKERS = int(os.getenv(ENV_VAR_PREFIX + "_REST_SERVER_WORKERS", "1"), base=10)
...
GBSERVER_SIDECAR_MONITORING_IMAGE_TAG = os.getenv(ENV_VAR_SIDECAR_MONITORING_IMAGE_TAG, "latest")
...
GBSERVER_WANDB_BASE_URL = os.getenv(ENV_VAR_PREFIX + "_WANDB_BASE_URL", "https://ibm.wandb.io")
...
GBSERVER_SQL_SSLROOT_CERT_BASE64 = os.getenv(ENV_VAR_GBSERVER_SQL_SSLROOT_CERT_BASE64, None)
...
PUBLIC_SPACE_LH_NAMESPACE = (
    f"{GRANITE_DOT_BUILD_PARENT_NAMESPACE}.{GB_ENVIRONMENT_CONFIG.public_space_lh_subnamespace}"
)
