...
_DEFAULT_LINEAGE_PROVIDER = "wandb" if GB_ENVIRONMENT.upper() != "STANDALONE" else ""
GBSERVER_LINEAGE_PROVIDER = os.getenv(ENV_VAR_PREFIX + "_LINEAGE_PROVIDER", _DEFAULT_LINEAGE_PROVIDER)
