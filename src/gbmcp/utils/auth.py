...
def get_github_token() -> str | None:
    ...
    gbmcp runs with **no auth verifier** in standalone (it's a local stdio
    process talking to an unauthenticated localhost gbserver), so there is
    usually no access token at all. Callers get
