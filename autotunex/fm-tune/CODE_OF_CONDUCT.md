...
AutoTune (`fm-tune`) project a harassment-free experience for everyone,
...
reject comments, commits, code, issues, pull requests, and other contributions
that are not aligned to this Code of Conduct, and will communicate reasons for
moderation decisions when appropriate.

### Who Are the Maintainers?

The project maintainers are the authors listed in `pyproject.toml`. As of this
writing they are Radu Marinescu, Daniel Karl I. Weidele, and Priyanshu Rai.
...
reported by contacting any of the project maintainers:

* Radu Marinescu — <radu.marinescu@ie.ibm.com>
* Daniel Karl I. Weidele — <daniel.karl@ibm.com>
* Priyanshu Rai — <Priyanshu.Rai@ibm.com>

If the report concerns a maintainer, send it to a different maintainer. All
...
* **When and where**: Date, time, and location (e.g., GitHub issue #123, PR
  review thread, conference)
...
**Response Timeline.** You will receive an acknowledgment within 2 business
days. The maintainer handling the report will communicate the outcome within 5
business days, or provide an update on the expected timeline for more complex
cases.

**Confidentiality.** Reports are kept confidential. Information will only be
shared with those who need to know to investigate and resolve the issue.

**Appeals.** If you believe an enforcement decision was made in error, you may
request a review by emailing a different maintainer with "Appeal" in the
subject line. Reviews will be handled by a maintainer not involved in the
original decision where possible.
