...
class TuningConfig(BaseModel):
    ...
    build_id: Optional[str] = Field(
        None, description="Build ID to associate with a gb_tasks record"
    )
...
class Configuration(BaseModel):
    ...
    artifact_id: Optional[str] = Field(
        None, description="Associated artifact identifier"
    )
    artifact_url: Optional[str] = Field(
        None, description="URL to configuration artifact"
    )
...
class SimpleConfiguration(BaseModel):
    ...
    tuner_type: Optional[str] = Field(None, description="HPO algorithm type")
