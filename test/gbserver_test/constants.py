...
ENV_VAR_GBTEST_COMPUTE_CLUSTER_SERVER_URI = TEST_ENV_VAR_PREFIX + "COMPUTE_CLUSTER_SERVER_URI"
...
GBTEST_COMPUTE_CLUSTER_PROJECT = os.getenv(ENV_VAR_GBTEST_COMPUTE_CLUSTER_PROJECT, "granite-build")
...
extended_testing_only = pytest.mark.skipif(
    os.environ.get(ENV_VAR_GBTEST_ENABLE_EXTENDED_TESTS, "true").lower() == "false",
