...
from gbserver.types.buildevent import ArtifactPushedEventPayload, BuildEvent, BuildEventMessagePayload, BuildEventMetricsPayload, BuildEventStatusPayload, BuildEventType, CreatedArtifactEventPayload, EntityRunMetadata
...
class EventStorageTestSupport(AbstractStorageTestSupport):
    ...
    def _get_test_item(self, index):
        ...
        build_event = BuildEvent(run_metadata=run_metadata, type=type, payload=payload, timestamp=timestamp, source=source)
