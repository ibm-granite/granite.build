...
import type { Build, BuildEvent, BuildStatusDetail, BuildTargetRun, K8sResource } from '@/types'
...
import { K8sResourcesPanel } from './K8sResourcesPanel'
...
interface BuildDetailsProps {
  ...
  events: BuildEvent[]
  k8sResources: K8sResource[] | null | undefined
      ...
      <div style={{ flex: 1, overflow: 'hidden', minHeight: 0 }}>
        <TabsVertical height="100%">
          ...
          <TabPanels>
            ...
            <TabPanel style={{ overflowY: 'auto', height: '100%' }}>
              <K8sResourcesPanel resources={k8sResources ?? []} />
            </TabPanel>
